...
setInterval(updateCountdown, 1000);
  ...
  try {
    ...
    const eventosResponse = await fetch('http://52.70.61.195:8080/event-0.0.1-SNAPSHOT1/api/events');
    ...
    const patrocinadoresResponse = await fetch("http://52.70.61.195:8080/event-0.0.1-SNAPSHOT1/api/sponsors"); // Cambia el nombre del archivo JSON
